...
public class ModEntities {
	...
	public static EntityEntry SCABYST_ITEM_FRAME;
	...
	public static void init() {
		SCABYST_ITEM_FRAME = EntityEntryBuilder.create()
				.entity(EntityScabystItemFrame.class)
				.id(new ResourceLocation(Reference.MODID, "scabyst_item_frame"), id)
				.name("scabyst_item_frame")
				.tracker(256, 64, true)
				.build();
		id++;
		ENTITIES.add(SCABYST_ITEM_FRAME);
