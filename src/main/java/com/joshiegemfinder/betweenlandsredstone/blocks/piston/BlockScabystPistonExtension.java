...
public class BlockScabystPistonExtension extends BlockDirectional implements IScabystBlock {

    public static final PropertyEnum<BlockScabystPistonExtension.EnumPistonType> TYPE = PropertyEnum.<BlockScabystPistonExtension.EnumPistonType>create("type", BlockScabystPistonExtension.EnumPistonType.class);
	...
	public BlockScabystPistonExtension(String name) {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH).withProperty(TYPE, BlockScabystPistonExtension.EnumPistonType.DEFAULT).withProperty(SHORT, Boolean.valueOf(false)));
    ...
    {
        return new ItemStack(state.getValue(TYPE) == BlockScabystPistonExtension.EnumPistonType.STICKY ? ModBlocks.SCABYST_STICKY_PISTON : ModBlocks.SCABYST_PISTON);
    }

    public IBlockState getStateFromMeta(int meta)
    {
        return this.getDefaultState().withProperty(FACING, getFacing(meta)).withProperty(TYPE, (meta & 8) > 0 ? BlockScabystPistonExtension.EnumPistonType.STICKY : BlockScabystPistonExtension.EnumPistonType.DEFAULT);
    }
