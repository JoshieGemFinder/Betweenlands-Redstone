...
public class BlockScabystComparator extends BlockScabystDiode implements ITileEntityProvider {

	public static final PropertyBool POWERED = PropertyBool.create("powered");
    public static final PropertyEnum<BlockScabystComparator.Mode> MODE = PropertyEnum.<BlockScabystComparator.Mode>create("mode", BlockScabystComparator.Mode.class);
    ...
    {
        return state.getValue(MODE) == BlockScabystComparator.Mode.SUBTRACT ? Math.max(this.calculateInputStrength(worldIn, pos, state) - this.getPowerOnSides(worldIn, pos, state), 0) : this.calculateInputStrength(worldIn, pos, state);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            float f = state.getValue(MODE) == BlockScabystComparator.Mode.SUBTRACT ? 0.55F : 0.5F;
    ...
    private void onStateChange(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (j != i || state.getValue(MODE) == BlockScabystComparator.Mode.COMPARE)
        {
    ...
    {
        return this.getDefaultState().withProperty(FACING, EnumFacing.getHorizontal(meta)).withProperty(POWERED, Boolean.valueOf((meta & 8) > 0)).withProperty(MODE, (meta & 4) > 0 ? BlockScabystComparator.Mode.SUBTRACT : BlockScabystComparator.Mode.COMPARE);
    }
    ...
    public int getMetaFromState(IBlockState state)
    {
        ...
        if (state.getValue(MODE) == BlockScabystComparator.Mode.SUBTRACT)
        {
            i |= 4;
        }
    ...
    {
        return this.getDefaultState().withProperty(FACING, placer.getHorizontalFacing().getOpposite()).withProperty(POWERED, Boolean.valueOf(false)).withProperty(MODE, BlockScabystComparator.Mode.COMPARE);
    }
