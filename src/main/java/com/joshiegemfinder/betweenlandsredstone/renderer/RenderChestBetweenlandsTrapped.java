...
public class RenderChestBetweenlandsTrapped extends TileEntitySpecialRenderer<TileEntityChestBetweenlandsTrapped> {
	...
	public RenderChestBetweenlandsTrapped() {
	...
	@Override
	public void render(TileEntityChestBetweenlandsTrapped te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		...
		if (te.adjacentChestZNeg == null && te.adjacentChestXNeg == null) {
			...
			if (te.adjacentChestXPos == null && te.adjacentChestZPos == null) {
				...
				} else if (te.getChestType() == BlockChestBetweenlandsTrapped.TRAPPED_WEEDWOOD_CHEST) {
					this.bindTexture(TEXTURE_WEEDWOOD);
				}
			} else {
