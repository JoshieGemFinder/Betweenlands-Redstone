...
public abstract class EntityScabystMinecartContainer  extends EntityScabystMinecart implements ILockableContainer, ILootContainer
{
    ...
    public EntityScabystMinecartContainer(World worldIn)
    {
        super(worldIn);
    }

    public EntityScabystMinecartContainer(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
